"""Deterministic, fail-closed live-target reacquisition."""
...
def evaluate_reacquisition(
    ...
    *,
    ...
    """Choose one strong same-track continuation only when no plausible rival exists."""
    ...
    competitors = [
        facts for facts in evidence if facts.plausible_competitor and not facts.selectable
    ]
...
def _candidate_evidence(
    ...
    shape_bounded = area_ratio <= policy.ordinary_area_ratio or (
